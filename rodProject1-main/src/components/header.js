...
import { useStudentContext } from '../customHooks/StudentContext'; // Import the context hook

function Headerpart() {
  const [anchorEl, setAnchorEl] = useState(null);
  const [selectedItem, setSelectedItem] = useState('Student');
  const { setStudentId } = useStudentContext(); // Get setStudentId from context
  ...
  const handleSearchChange = (event) => {
    ...
    setStudentId(newStudentId); // Update studentId in context
  };

  return (

    <div className="container-fluid d-flex flex-col bg-light gap-5 align-items-center" style={{ height: "8vh" }}>
      <div className="navbar-brand ms-2" >
        <img src={chaitanyalogo} alt="logo" style={{ height: "50px", width: "170px" }} />
      </div>

      <div className="d-flex align-items-center ms-5 bg-light border">
        <select
          className="form-select border-end"
          value={selectedItem}
        ...
        <div className='d-flex bg-light' style={{ width: "200px" }} >
          <div className="ps-1 pt-2 bg-light">
      ...
      <div className="d-flex align-items-center gap-5 ms-auto me-3">
        <div className="d-flex align-iteams-center rounded px-2 gap-2 py-2 " style={{ boxShadow: "0px 0px 8px rgba(13, 110, 253, 0.3), 0 0 20px rgba(13, 110, 253, 0.1)" }}>
          <svg
        ...
        <div className="d-flex align-items-center gap-4 ms-3 ">
          ...
          <div className="cashier_details d-flex align-items-center gap-1" style={{ height: '100%' }}>
            ...
            <div className="cashier_text d-flex-row m-1  pt-1">
              <p
                style={{
            ...
            <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ justifyContent: "center" }}>
